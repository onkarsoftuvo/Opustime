...
Owner.skip_callback(:create, :after, :set_owner_user_role)
unless Owner.find_by_role('super_admin_user').present?
  user = Owner.new(first_name: "Jame", last_name: "Rock", email: "poulin@gmail.com", password: "shiv@260!", role: 'super_admin_user', status: true)
  if user.valid?
    user.save
  end
end
...
#  Creating 6 models for tabs(Patient , contact ,other , business , refering doc , general)

# PatientTab.create()
puts "calling seed.rake "

# Creating roles records
